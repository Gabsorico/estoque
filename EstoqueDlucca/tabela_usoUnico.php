<?php
    ...
    $tabela = $pdo->prepare("SELECT * FROM produto WHERE emprestado = 'Não' AND tipo_prod = 'Uso Único'");
    $tabela->execute();
...
<html lang="pt-br">
    ...
    <body>
        ...
        <br>
            ...
            <br><br><br>
            <h1 style="text-align:center;">Tabela de Materiais de Uso Único</h1>
            <br>  
        <table class="table">
        <thead>
            <tr>
            ...
            <th scope="col"><a href="tabela.php" class="btn btn-primary">TIPO DO PRODUTO</a></th>
        ...
        <a href="registrar_entrada.php" class="btn btn-info">CADASTRAR MATERIAL</a>
        <br>
        <br>
