<?php
    ...
    $tabela = $pdo->prepare("SELECT * FROM produto ORDER BY entrada_prod DESC LIMIT 10");
    $tabela->execute();
...
<html lang="pt-br">
    ...
    <body>
        ...
        <a href="tabela.php" class="btn btn-primary">TABELA GERAL</a>
        <br>
            <h1 style="text-align:center;">Últimos Produtos Cadastrados</h1>
            <br>  
        <table class="table">
        <thead>
            <tr>
